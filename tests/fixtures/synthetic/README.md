...
parameters and the accompanying scenario clocks are not derived from a
personal policy. Tests load it explicitly; the engine never loads it as a
fallback or treats it as permission for personal actions.
